 ...
 */
function portfolio_html_head_alter(&$head_elements) {
  // Borrowed from Boron
 ...
 */
function portfolio_preprocess_html(&$vars) {
  ...
  $vars['classes_array'][] = drupal_html_class('layout-' . portfolio_active_layout());
}

/**
 * Preprocesses variables for page template.
 */
function portfolio_preprocess_page(&$vars) {
  ...
  $vars['title_tabs_content_wrapper_classes'] = implode(' ', _portfolio_region_classes('title_tabs_content'));
}

/**
 * Process page variables as late as possible.
 */
function portfolio_process_page(&$vars) {
 ...
 */
function portfolio_preprocess_maintenance_page(&$vars) {
 ...
 */
function portfolio_process_maintenance_page(&$vars) {
 ...
 */
function _portfolio_region_classes($region) {
  $layouts = _portfolio_layouts();
  $layout = portfolio_active_layout();
 ...
 */
function portfolio_active_layout() {
  static $layout;
...
function _portfolio_layouts() {
  ...
  if (!isset($layouts)) {
    ...
    drupal_alter('portfolio_layouts', $layouts);
  }
  return $layouts;
}
 ...
 */
function portfolio_preprocess_region(&$vars) {
  $vars['classes_array'] = array_merge($vars['classes_array'], _portfolio_region_classes($vars['region']));
}

/**
 * Changes the search form to use the "search" input element of HTML5.
 */
function portfolio_preprocess_search_block_form(&$vars) {
  // Borrowed from Boron
 ...
 */
function portfolio_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
 ...
 */
function portfolio_pager_link($vars) {
  $text = $vars['text'];
