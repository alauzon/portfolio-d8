  ...
  The module will populate a new block named "Language switcher link" under "{host}/admin/build/block".
  ...
  2) Enable the "Language switcher link" block at "{host}/admin/build/block".
  
  3) Configure the "Language switcher link" block settings as follows:
